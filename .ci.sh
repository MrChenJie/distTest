...
export BUILD_API_HOST=http://gatewayd.eps2.mcd.com.cn
export BUILD_CLIENT_ID=srm-portal
export BUILD_WFP_EDITOR=""
export BUILD_WEBSOCKET_HOST=ws://messaged.eps2.mcd.com.cn
...
export BUILD_SRC_WEBSOCKET_HOST=http://sourced.eps2.mcd.com.cn
export BUILD_WFP_EDITOR=http://gatewayd.eps2.mcd.com.cn/hwfp
...
find ./html -name '*.js' | xargs sed -i "s BUILD_SRC_WEBSOCKET_HOST $BUILD_SRC_WEBSOCKET_HOST g"
find ./html -name '*.js' | xargs sed -i "s BUILD_WFP_EDITOR $BUILD_WFP_EDITOR g"
