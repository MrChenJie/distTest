...
export async function queryRules() {
  return request(`${SRM_SPUC}/v1/${organizationId}/bill-update-rules`, {
    method: 'GET',
  });
}
...
export async function queryRuleLines(params) {
  ...
  return request(`${SRM_SPUC}/v1/${organizationId}/bill-update-rule-dtl/${ruleId}`, {
    method: 'GET',
    query,
  });
}
...
export async function saveRuleLines(params) {
  return request(`${SRM_SPUC}/v1/${organizationId}/bill-update-rule-dtl`, {
    method: 'POST',
    body: params,
  });
}
