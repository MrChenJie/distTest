...
export async function fetchBillRule(params) {
  ...
  return request(`${SRM_SPUC}/v1/${organizationId}/invoice-rules/queryRules`, {
    method: 'GET',
    query,
  });
}
...
export async function saveBillRule(params) {
  return request(`${SRM_SPUC}/v1/${organizationId}/invoice-rules`, {
    method: 'POST',
    body: params,
  });
}
...
export async function fetchRuleDetail(params) {
  const query = parseParameters(params);
  return request(`${SRM_SPUC}/v1/${organizationId}/invoice-rule-detail`, {
    method: 'GET',
    query,
  });
}
...
export async function fetchRuleType(params) {
  return request(`${SRM_SPUC}/v1/${organizationId}/invoice-rules/queryType`, {
    method: 'GET',
    query: params,
  });
}
...
export async function addAll(params) {
  return request(`${SRM_SPUC}/v1/${organizationId}/invoice-rules/invoiceAll`, {
    method: 'POST',
    body: params,
  });
}
...
export async function fetchSupplierLovData(params) {
  ...
  return request(`${SRM_SPUC}/v1/${organizationId}/invoice-rule-detail/notAdded`, {
    method: 'GET',
    query: param,
  });
}
