...
// http://172.22.141.69:8080/hpfm/v1/lovs/sql/data?condition=CN&enabledFlag=1&lovCode=HPFM.COUNTRY
export async function queryCNCountry() {
  return request(
    `${HZERO_PLATFORM}/v1/lovs/sql/data?condition=CN&enabledFlag=1&lovCode=HPFM.COUNTRY`
  );
}
 ...
 */
export async function queryCompanyBasicWithSupplierId(params) {
  const { ibossSupplierId } = params;
  return request(`${SRM_PLATFORM}/v1/companies/basic/queryByIBossSupplierId/${ibossSupplierId}`);
}
 ...
 * @export
 */
export async function validateCompanyEnglishName(param) {
  return request(`${SRM_PLATFORM}/v1/companies/basic/company-english-name`, {
    method: 'GET',
    query: param,
  });
}
 ...
 * @export
 */
export async function validateCompanyEmail(param) {
 ...
 * @export
 */
export async function fetchRepeatCompany(params) {
  return request(`${SRM_PLATFORM}/v1/companies/basic/checkList`, {
    method: 'POST',
    body: params,
  });
}
 ...
 * @export
 */
export async function companyCheckResult(params) {
  const query = filterNullValueObject(parseParameters(params));
  return request(`${SRM_PLATFORM}/v1/portal-company/selectCompanyCheckResult`, {
    method: 'GET',
    query,
  });
}
