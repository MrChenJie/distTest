...
export async function queryDocMergeRulesList(params) {
  return request(`${SRM_SPUC}/v1/${params.organizationId}/doc-merge-rules`, {
    method: 'GET',
    query: params,
  });
}
...
export async function fetchPurchaseRequisitionApprovalList() {
  return request(`${SRM_SPUC}/v1/${organizationId}/purchase-request/approve-rules`, {
    method: 'GET',
  });
}
...
export async function fetchPurchaseRequisitionSendBackPurchaseRequest() {
  return request(`${SRM_SPUC}/v1/${organizationId}/purchase-request/sync-configs/list`, {
    method: 'GET',
    // query: parseParameters(params),
  });
}
...
export async function savefetchPurchaseRequisitionSendBackPurchaseRequest(params) {
  return request(
    `${SRM_SPUC}/v1/${organizationId}/purchase-request/sync-configs/batch-create-update`,
    {
      method: 'POST',
      body: params,
    }
...
export async function deletefetchPurchaseRequisitionSendBackPurchaseRequest(params) {
  return request(`${SRM_SPUC}/v1/${organizationId}/purchase-request/sync-configs/batch`, {
    method: 'DELETE',
    body: params,
  });
}
...
export async function fetchNotPermitList(params) {
  ...
  return request(
    `${SRM_PLATFORM}/v1/${organizationId}/electronic-sign/online-confirm-supplier/not-permit/page`,
    {
      method: 'GET',
...
export async function directInvoiceRules(params) {
  const query = filterNullValueObject(parseParameters(params));
  return request(`${SRM_SPUC}/v1/${organizationId}/direct-invoice-rule`, {
    method: 'GET',
    query,
  });
}
...
export async function directInvoiceRulesDetails(params) {
  const query = filterNullValueObject(parseParameters(params));
  return request(`${SRM_SPUC}/v1/${organizationId}/direct-invoice-rule/detail`, {
    query,
    method: 'GET',
  });
}
...
export async function directInvoiceInfo(params) {
  const query = filterNullValueObject(parseParameters(params));
  return request(`${SRM_SPUC}/v1/${organizationId}/direct-invoice-basics`, {
    method: 'GET',
    query,
  });
}
...
export async function fetchShieldNeedsInfList(params) {
  const query = filterNullValueObject(parseParameters(params));
  return request(`${SRM_SPUC}/v1//${organizationId}/supplier-hide-roles`, {
    query,
    method: 'GET',
  });
}
...
export async function fetchPurchaserUpdateFields(params) {
  const query = filterNullValueObject(parseParameters(params));
  return request(`${SRM_SPUC}/v1/${organizationId}/pr-change-configs`, {
    method: 'GET',
    query,
  });
}
...
export async function fetchReconciliationSource(params) {
  return request(`${SRM_SPUC}/v1/${organizationId}/data-source-configs`, {
    method: 'GET',
    query: params,
  });
}
