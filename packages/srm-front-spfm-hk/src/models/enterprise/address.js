...
import { queryProvinceCity, queryAddressList, saveAddressList, deleteAddress } from '@/services/addressService';
import { loadCityData, queryCompanyBasicWithCompanyId } from '@/services/legalService';
...
export default {
  ...
  effects: {
    ...
    *queryCompanyBasicWithCompanyId({ payload }, { call }) {
      const legalInfo = yield call(queryCompanyBasicWithCompanyId, payload);
      return legalInfo;
    },

    *deleteAddress({ payload }, { call }) {
      return getResponse(yield call(deleteAddress, payload));
    },
  },
