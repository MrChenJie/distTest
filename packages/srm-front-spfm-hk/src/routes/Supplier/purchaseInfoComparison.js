...
export default class PurchaseInfoComparison extends Component {
  ...
  render() {
    ...
    const { previousCustomers = [], nextCustomers = [] } = baseInfoUpdateCustomerCompare;
    ...
    const previousCustomersTableProps = {
      rowKey: 'id',
      dataSource: previousCustomers,
      otherDataSource: nextCustomers,
      rowSelection: {
        getCheckboxProps: () => ({
          disabled: true
        })
    ...
    const nextCustomersTableProps = {
      rowKey: 'uuid',
      dataSource: nextCustomers,
      otherDataSource: previousCustomers,
      rowSelection: {
        getCheckboxProps: () => ({
          disabled: true
        })
        ...
        <PageWrapper loading={loading}>
          ...
          >
                  ...
                  <Col {...gridSpan} className="after-border">
                    ...
                    <Col {...gridSpan}>
                      ...
                      >
                        {getFieldDecorator('countryBefore', {
                          ...
                          initialValue: previousHead?.country,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                    ...
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.inclusion.reason`).d('入围原因')}
                                 className={getFieldValue('reasonBefore') !== getFieldValue('reasonAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('reasonBefore', {
                          initialValue: previousHead?.linePrevious?.reasonMeaning,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.inclusion.reasontext`).d('补充入围原因')}
                                 className={getFieldValue('repairReasonBefore') !== getFieldValue('repairReasonAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('repairReasonBefore', {
                          initialValue: previousHead?.linePrevious?.repairReason,
                        })(<CusInput style={{ width: '100%' }} readOnly/>)}
                      </Form.Item>
                    </Col>
                    {/*{previousHead?.reason === 'Others' && (

                    )}*/}
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.remark`).d('备注')}
                                 className={getFieldValue('purchaseInfoBefore') !== getFieldValue('purchaseInfoAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('purchaseInfoBefore', {
                          initialValue: previousHead?.linePrevious?.purchaseInfo,
                        })(<CusInput style={{ width: '100%' }} readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.credit.ratescore`).d('信用评估分数')}
                                 className={getFieldValue('creditScoreBefore') !== getFieldValue('creditScoreAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('creditScoreBefore', {
                          initialValue: previousHead?.linePrevious?.creditScore
                        })(
                          <CusInput style={{ width: '100%' }} readOnly/>
                          )}
                      </Form.Item>
                    ...
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.credit.rate`).d('供应商信用级别')}
                                 className={getFieldValue('creditRatingBefore') !== getFieldValue('creditRatingAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('creditRatingBefore', {
                          initialValue: previousHead?.linePrevious?.creditRating
                        })(
                          <CusInput style={{ width: '100%' }} readOnly/>
                          )}
                      </Form.Item>
                    ...
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.partnersName`).d('合伙人姓名')}
                                 className={getFieldValue('partnerNameBefore') !== getFieldValue('partnerNameAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('partnerNameBefore', {
                          initialValue: previousHead?.linePrevious?.partnerName,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.directorsName`).d('董事姓名')}
                                 className={getFieldValue('directorNameBefore') !== getFieldValue('directorNameAfter') ? `tips-input-text-color` : ''}
                                 tip={
                                   <div>
                      ...
                      >
                        {getFieldDecorator('directorNameBefore', {
                          initialValue: previousHead?.linePrevious?.directorName,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.employees.num`).d('聘用职员总数')}
                                 className={getFieldValue('headcountBefore') !== getFieldValue('headcountAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('headcountBefore', {
                          rules: [
                            {
                              required: true,
                              message: intl.get('hzero.common.validation.notNull', {
                          ...
                          initialValue: previousHead?.linePrevious?.headcount,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      ...
                      >
                        {getFieldDecorator('supModifyStateBefore', {
                          initialValue: previousHead?.supModifyStateMeaning || 'Draft'
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                  ...
                  <Col {...gridSpan}>
                    ...
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.inclusion.reason`).d('入围原因')}
                                 className={getFieldValue('reasonBefore') !== getFieldValue('reasonAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('reasonAfter', {
                          initialValue: nextHead?.lineNext?.reasonMeaning,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.inclusion.reasontext`).d('补充入围原因')}
                                 className={getFieldValue('repairReasonBefore') !== getFieldValue('repairReasonAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('repairReasonAfter', {
                          initialValue: nextHead?.lineNext?.repairReason,
                        })(<CusInput style={{ width: '100%' }} readOnly />)}
                      </Form.Item>
                    </Col>
                    {/*{nextHead?.reason === 'Others' && (
                    ...
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.remark`).d('备注')}
                                 className={getFieldValue('purchaseInfoBefore') !== getFieldValue('purchaseInfoAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('purchaseInfoAfter', {
                          initialValue: nextHead?.lineNext?.purchaseInfo,
                        })(<CusInput style={{ width: '100%' }} readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.credit.ratescore`).d('信用评估分数')}
                                 className={getFieldValue('creditScoreBefore') !== getFieldValue('creditScoreAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('creditScoreAfter', {
                          initialValue: nextHead?.lineNext?.creditScore
                        })(
                          <CusInput style={{ width: '100%' }} readOnly/>
                          )}
                      </Form.Item>
                    ...
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.credit.rate`).d('供应商信用级别')}
                                 className={getFieldValue('creditRatingBefore') !== getFieldValue('creditRatingAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('creditRatingAfter', {
                          initialValue: nextHead?.lineNext?.creditRating
                        })(
                          <CusInput style={{ width: '100%' }} readOnly/>
                          )}
                      </Form.Item>
                    ...
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.partnersName`).d('合伙人姓名')}
                                 className={getFieldValue('partnerNameBefore') !== getFieldValue('partnerNameAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('partnerNameAfter', {
                          initialValue: nextHead?.lineNext?.partnerName,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      ...
                      >
                        {getFieldDecorator('directorNameAfter', {
                          initialValue: nextHead?.lineNext?.directorName,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
                      <Form.Item label={intl.get(`${prompt}.field.employees.num`).d('聘用职员总数')}
                                 className={getFieldValue('headcountBefore') !== getFieldValue('headcountAfter') ? `tips-input-text-color` : ''}
                      >
                        {getFieldDecorator('headcountAfter', {
                          rules: [
                            {
                              required: true,
                              message: intl.get('hzero.common.validation.notNull', {
                          ...
                          initialValue: nextHead?.lineNext?.headcount,
                        })(<CusInput readOnly/>)}
                      </Form.Item>
                    </Col>
                    <Col {...gridSpan}>
            ...
            <Panel
              ...
              header={
                <PanelHeader
                  title={intl.get(`${prompt}.view.title.client.information.update`).d('变更客户信息')}
            ...
            >
              <Row gutter={24}>
                <Col {...gridSpan} className="after-border">
                  <h5>{intl.get(`${prompt}.view.title.update.before`).d('变更前')}</h5>
                  <ClientTable {...previousCustomersTableProps}/>
                </Col>
                <Col {...gridSpan}>
                  <h5>{intl.get(`${prompt}.view.title.update.after`).d('变更后')}</h5>
                  <ClientTable {...nextCustomersTableProps}/>
                </Col>
              </Row>
            </Panel>
            <Panel
