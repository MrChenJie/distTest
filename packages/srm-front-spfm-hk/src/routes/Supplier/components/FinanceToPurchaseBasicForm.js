...
export default class FinanceToPurchaseBasicForm extends PureComponent {
  constructor(props) {
    super(props);
    props.onRef(this);
    this.state = {
        ...
        <GenerateFormGrid isPackUp={false}>
          <Col {...gridSpan}>
            <Form.Item label={intl.get(`${prompt}.field.company.name.en`).d('公司名称（英文）')}>
              ...
              })(<CusInput disabled={disabled} allowClear  placeholder={intl.get(`${prompt}.field.company.name.en.placeholder`).d('请输入公司英文名称，若没有，录入N/A')}/>)}
            </Form.Item>
          </Col>
          <Col {...gridSpan}>
            <Form.Item label={intl.get(`${prompt}.field.company.name.cn`).d('公司名称（中文）')}>
              ...
              })(<CusInput disabled={disabled} allowClear  placeholder={intl.get(`${prompt}.field.company.name.cn.placeholder`).d('请输入公司中文名称')}/>)}
            </Form.Item>
          </Col>
          <Col span={24}>
          ...
          <Col {...gridSpan}>
            <Form.Item label={intl.get(`${prompt}.field.telNo`).d('电话号码')}>
              ...
              })(<CusInput disabled={disabled} allowClear  placeholder={intl.get(`${prompt}.field.telNo.placeholder`).d('请输入公司联系电话')}/>)}
            </Form.Item>
          </Col>
          <Col {...gridSpan}>
            <Form.Item label={intl.get(`${prompt}.field.faxNo`).d('传真号码')}>
              ...
              })(<CusInput disabled={disabled} allowClear  placeholder={intl.get(`${prompt}.field.placeHolder.null`).d('若没有，录入N/A')}/>)}
            </Form.Item>
          </Col>
          <Col {...gridSpan}>
          ...
          <Col {...gridSpan}>
            <Form.Item label={intl.get(`${prompt}.field.web`).d('公司网址')}>
              ...
              })(<CusInput disabled={disabled} allowClear  placeholder={intl.get(`${prompt}.field.web.placeHolder`).d('请输入公司网址')}/>)}
            </Form.Item>
          </Col>
          <Col {...gridSpan}>
          ...
          <Col {...gridSpan}>
            <Form.Item label={intl.get(`${prompt}.field.supply.of.goods.services`).d('供应货品/服务')}>
              ...
              })(<CusInput disabled={disabled} allowClear  placeholder={intl.get(`${prompt}.field.supplier.product.placeholder`).d('请输入供应品牌类型')}/>)}
            </Form.Item>
          </Col>
          <Col {...gridSpan}>
          ...
          <Col {...gridSpan}>
            <Form.Item label={intl.get(`${prompt}.field.company.establishment.date`).d('公司成立日期')}>
              {getFieldDecorator('foundDate', {
                ...
                //   required: true,
                //   message: intl.get('hzero.common.validation.notNull', {
                //     name: intl.get(`${prompt}.field.company.establishment.date`).d('公司成立日期'),
                //   }),
                // }],
                initialValue: initialValues?.foundDate ? dayjs(initialValues?.foundDate) : null,
              })(<CusDatePicker disabled={disabled} format={getDateFormat()} style={{ width: '100%' }}  placeholder={intl.get(`${prompt}.field.company.establishment.date.placeholder`).d('请选择公司成立日期')}/>)}
            </Form.Item>
          </Col>
          <Col {...gridSpan}>
            <Form.Item label={intl.get(`${prompt}.field.company.location`).d('公司成立地点')}>
              ...
              })(<CusInput disabled={disabled} allowClear placeholder={intl.get(`${prompt}.field.company.location.placeholder`).d('请输入公司注册地址')}/>)}
            </Form.Item>
          </Col>
          <Col {...gridSpan}>
