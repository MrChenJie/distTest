...
import RemoveForm from '@/routes/Status/components/RemoveForm';
        ...
        dispatch({
          ...
          if(typeof callback === 'function') {
            callback({
              ...
              affairTitle: intl.get(`${prompt}.todotask.delistsupplier.apply`).d('除名供应商申请：') + statusUpdateInfo?.head?.companyNameCh,
            })
          }
        })
      }
