...
export default class SupplierFormSummary extends PureComponent {
  ...
  render() {
    ...
    const formItemList = [
      <Col span={colSpan}>
        <Form.Item
          label={intl.get(`spfmhk.supplier.basic.info.sumOrder.No`).d('汇总单号')}
          name='gatNo'
        >
          <CusInput />
        </Form.Item>
      ...
      <Col span={colSpan}>
        <Form.Item
          label={intl.get(`spfmhk.supplier.basic.info.supplierGrade`).d('供应商等级')}
          name='revGrade'
        >
          <CusInput />
        </Form.Item>
      ...
      <Col span={colSpan}>
        <Form.Item
          label={intl.get(`spfmhk.supplier.basic.info.classDFrequency`).d('E级频次')}
          name='eFrequency'
        >
          <CusInput />
        </Form.Item>
      ...
      <Col span={colSpan}>
        <Form.Item
          label={intl.get(`spfmhk.supplier.basic.info.sumScore.Date`).d('评分汇总日期')}
          name='gatTime'
        >
          <CusDatePicker
            allowClear
            ...
            disabledDate={currentData => {
              return (currentData && currentData.isAfter(dayjs()))
            }}
          />
        </Form.Item>
      </Col>,
