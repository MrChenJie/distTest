 ...
 * @param {object} params - 请求参数
 */
export async function testAuth(interfaceId, data) {
  return request(
    organizationRoleLevel
      ? `${HZERO_HITF}/v1/${organizationId}/${interfaceId}/auth/auth-test`
      : `${HZERO_HITF}/v1/${interfaceId}/auth/auth-test`,
    {
      method: 'POST',
      body: data,
    }
...
export async function batchAddAuth(payload) {
  return request(
    organizationRoleLevel ? `${HZERO_HITF}/v1/${organizationId}/auth` : `${HZERO_HITF}/v1/auth`,
    {
      method: 'PUT',
      body: payload,
    }
