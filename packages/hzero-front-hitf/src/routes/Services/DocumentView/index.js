...
export default class DocumentView extends Component {
  ...
  private Map<String, String> headerParamMap; // Reqeust Header参数列列表
  private Map<String, String> pathVariableMap; // Path变量量列列表
  private Map<String, String> requestParamMap; // 请求查询参数列列表
  private String mediaType; // 指定payload解析格式，默认为application/json;charset=UTF-8
  private String payload; // 指定payload实体内容
}`}
                  </code>
                </pre>
  ...
  private String apiWarnings; // api警告信息，例例如，即将过期
}
 public Class ResponseResult {
  private String status;
  private String message;
  private String mediaType; // 指定payload解析格式，默认为:application/json;charset=UTF-8
  private String payload; // 指定payload实体内容
  private ApiInfo apiInfo; // API信息
}`}
                  </code>
                </pre>
              </div>
                    ...
                    {handledReqMimeType === 'raw' ? (
                      <div style={{ width: '80%', height: '300px' }}>
                        <CodeMirror
                          ...
                          value={bodyData[handledReqMimeType][0].defaultValueLongtext || ''}
                    ...
                    {handledRespMimeType === 'raw' ? (
                      <div style={{ width: '80%', height: '300px' }}>
                        <CodeMirror
                          autoScroll
                          className={styles['hzero-codemirror']}
                          value={respBodyData[handledRespMimeType][0].defaultValueLongtext || ''}
                          editorDidMount={this.handleCodeMirrorRef}
                          readOnly
                          options={{
                            mode: 'javascript',
