  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        title: isReq
          ? intl
              .get(`hitf.typeDefinition.model.typeDefinition.sourceParamNameType`)
              .d('实例参数类型')
          : intl
              .get(`hitf.typeDefinition.model.typeDefinition.combineParamNameType`)
              .d('组合参数类型'),
      ...
      },
      {
        title: isReq
          ? intl
              .get(`hitf.typeDefinition.model.typeDefinition.sourceParamNameRemark`)
              .d('实例参数说明')
          : intl
              .get(`hitf.typeDefinition.model.typeDefinition.combineParamNameRemark`)
              .d('组合参数说明'),
        ...
        render: (val, record) => {
          ...
          if (record._status === 'update') {
            ...
            operators.push({
              ...
              len: 2,
              title: intl.get('hzero.common.status.edit').d('编辑'),
            });
          }
