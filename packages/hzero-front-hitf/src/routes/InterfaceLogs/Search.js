      ...
      <Form layout="inline" className="more-fields-search-form">
        ...
        <Row {...SEARCH_FORM_ROW_LAYOUT} style={expandForm ? expandFormStyle : noExpandFormStyle}>
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
              label={intl
                .get(`hitf.interfaceLogs.model.interfaceLogs.responseStatus`)
                .d('请求状态')}
              {...SEARCH_FORM_ITEM_LAYOUT}
            >
              ...
              {getFieldDecorator('interfaceRequestTimeStart')(
                <DatePicker
                  ...
                  disabledDate={currentDate =>
                    ...
                    moment(getFieldValue('interfaceRequestTimeEnd')).isBefore(currentDate, 'time')
                  }
                  style={{ width: '100%' }}
              ...
              {getFieldDecorator('interfaceRequestTimeEnd')(
                <DatePicker
                  ...
                  disabledDate={currentDate =>
                    ...
                    moment(getFieldValue('interfaceRequestTimeStart')).isAfter(currentDate, 'time')
                  }
                  style={{ width: '100%' }}
                  showTime={{ defaultValue: moment('00:00:00', 'HH:mm:ss') }}
                />
        ...
        <Row {...SEARCH_FORM_ROW_LAYOUT} style={expandForm ? expandFormStyle : noExpandFormStyle}>
          ...
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
              label={intl
                .get(`hitf.interfaceLogs.model.interfaceLogs.interfaceUrl`)
                .d('接口地址')}
              {...SEARCH_FORM_ITEM_LAYOUT}
            >
              {getFieldDecorator('interfaceUrl')(<Input />)}
            </Form.Item>
          </Col>
          {tenantRoleLevel && (<Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
              label={intl
                .get(`hitf.interfaceLogs.model.interfaceLogs.interfaceReqBodyParam`)
                .d('调用参数')}
              {...SEARCH_FORM_ITEM_LAYOUT}
            >
              {getFieldDecorator('interfaceReqBodyParam')(<Input />)}
            </Form.Item>
          </Col>)}
        </Row>
        <Row {...SEARCH_FORM_ROW_LAYOUT} style={expandForm ? expandFormStyle : noExpandFormStyle}>
          ...
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
              label={intl
                .get(`hitf.interfaceLogs.model.interfaceLogs.interfaceRespContent`)
                .d('响应内容')}
              {...SEARCH_FORM_ITEM_LAYOUT}
            >
              {getFieldDecorator('interfaceRespContent')(<Input />)}
            </Form.Item>
          </Col>
        </Row>
      </Form>
