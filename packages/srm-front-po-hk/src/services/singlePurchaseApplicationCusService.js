...
// 查询简易询价详情 优先调用这个  // 50<hkd<100w 修改后
export async function firstQueryDetail(params) {
  return cusRequest(`${prefix}/pr-third-heads/bidThirdHeadTrue/${params.packageNo}`, {
    method: 'GET',
  });
}
// 查询简易询价详情   // 50<hkd<100w 修改后
export async function queryDetail(params) {
  return cusRequest(`${prefix}/pr-third-heads/bidThirdHead/${params.packageNo}`, {
    method: 'GET',
  });
}
...
export async function getSupplierList(params) {
  ...
  return cusRequest(`${prefix}/pr-third-sups/bidSupQueryList`, {
    query,
  });
}
/**
 * -查询列表  物料查询  // 50<hkd<100w 修改后
 * @param {Object} params - 查询参数
 * @param {String} params.page - 页码
 * @param {String} params.size - 页数
 */
export async function getMaterialList(params) {
  const query = filterNullValueObject(parseParameters(params));
  return cusRequest(`${prefix}/pr-apply-materials/bidMatQueryList`, {
    query,
  });
}
...
export async function getPriceCollect(params) {
  return cusRequest(`${prefix}/pr-third-heads/getPrThirdPriceSum2?refHeadId=${params.id}`, {
    method: 'GET',
  });
}
// 查询价格汇总基本信息
...
// 查询价格汇总 物料信息
export async function getMatListBefore(params) {
  const query = filterNullValueObject(parseParameters(params));
  return cusRequest(`${prefix}/pr-third-heads/getSettingBefore`, {
    method: 'GET',
    query,
  });
}
...
export async function getReviewPrice(params) {
  return cusRequest(`${prefix}/pr-third-heads/getPrThirdPrice`, {
    method: 'GET',
    query: params,
  });
}
...
export async function priceSummarySave(params) {
  return cusRequest(`${prefix}/pr-third-heads/savePriceTol2`, {
    method: 'POST',
    body: params,
  });
}
...
export async function getQuotationListDetail(params) {
  const query = filterNullValueObject(parseParameters(params));
  return cusRequest(`${prefix}/pr-third-heads/getPrThirdAllQuotationList2`, {
    method: 'GET',
    query,
  });
}
// 查询100万报价文件详情数据——报价表
export async function getQuotationListDetailBid(params) {
  const query = filterNullValueObject(parseParameters(params));
  return cusRequest(`/bidding/v1/${organizationId}/bid-pro-price-configs/view/getBidAllQuotationList`, {
    method: 'GET',
    query,
  });
}
...
export async function demanderEditQuery(params) {
  return cusRequest(
    `${prefix}/pr-third-inquirys/prThirdConfirmationSearch2/${params.prThirdHeadId}`,
    {
      method: 'GET',
    }
  );
...
/**
 * -查询列表  需求人确认执行 物料查询  // 50<hkd<100w 修改后
 * @param {Object} params - 查询参数
 * @param {String} params.page - 页码
 * @param {String} params.size - 页数
 * @param {String} params.refHeadId
 */
export async function getMatSup(params) {
  const query = filterNullValueObject(parseParameters(params));
  return cusRequest(`${prefix}/pr-third-quote-settings/getMatSup2`, {
    method: 'GET',
    query,
  });
}
/**
 * -查询列表  需求人确认执行 物料弹窗查询（放大镜）  // 50<hkd<100w 修改后
 * @param {Object} params - 查询参数
 * @param {String} params.page - 页码
 * @param {String} params.size - 页数
 * @param {String} params.refHeadId
 * @param {String} params.quoteTotalId
 */
export async function getQuoteMatList(params) {
  const query = filterNullValueObject(parseParameters(params));
  return cusRequest(`${prefix}/pr-third-inquirys/getInquiryMat`, {
    method: 'GET',
    query,
  });
}
...
export async function getInquireDetail(params) {
  const query = filterNullValueObject(parseParameters(params));
  return cusRequest(`${prefix}/cmhk-pr-fourth-heads/getSupplierQuoteDetailByPpId2`, {
      method: 'GET',
      query: query,
    }
  );
...
export async function saveSelectSupplier(params) {
  return cusRequest(`${prefix}/pr-third-heads/saveSelectSupTotal`, {
    method: 'POST',
    body: params
  });
}
