...
export default class Upload extends PureComponent {
  ...
  componentDidMount() {
    const { bucketName = DEFAULT_BUCKET_NAME, attachmentUUID, tenantId, returnFileList } = this.props;
    if (attachmentUUID) {
      queryFileList({
        tenantId,
        bucketName,
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    const { bucketName = DEFAULT_BUCKET_NAME, tenantId, returnFileList } = this.props;
