...
const LineAttachment = ({ dataSet, defaultFlag, fileFlag, isOther }) => {
    ...
    },
    {
      ...
      renderer: ({ record }) => (
        <Upload
          ...
          // fileType={['INVOICE'].includes(record.get('fileType')) ? 'application/pdf' : ''}
        />
      ),
    },
  ];
