 ...
 */
  fetchEnum = () => {
    ...
    dispatch({
      type: 'singlePurchaseApplicationCusModel/fetchDetailEnum',
    });
  }

  handleAddMat = () => {
    const { singlePurchaseApplicationCusModel, dispatch } = this.props;
    const { editMatDataSource, priceBasicInfo } = singlePurchaseApplicationCusModel;
  ...
  render() {
    ...
    const { priceBasicInfo = {}, editMatDataSource = [], detailEnumMap = {} } = singlePurchaseApplicationCusModel;
