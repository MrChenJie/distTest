...
// 复制明细行
// POST   https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-details/copy
...
// ICTS复制明细行
// POST   https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-details/icts/copy
...
// 删除明细行
// DELETE   https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-details
...
// 附件查询
// GET   https://scm-uat.cmitry.com:8443/ssrc//v1/{organizationId}/enquiry-files?enquiryPriceId=1
...
// 附件删除
// DELETE   https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-files
...
// 突发流量查询
// GET  https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-detail-qt-dbts?enquiryDetailQtId=1
...
// 突发流量查询-审计
// GET  https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-qt-dbt-audits?enquiryDetQtAdId=1
...
// 突发流量保存
// POST  https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-detail-qt-dbts
...
// 突发流量删除
// DELETE https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-detail-qt-dbts
...
// 会话查询
// GET  https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-conversations?enquiryPriceId=1&supplierId=1
...
// 会话发送
// POST   https://scm-uat.cmitry.com:8443/ssrc/v1/{organizationId}/enquiry-conversations
...
// ICTS 会话发送
// POST  /v1/{organizationId}/enquiry-conversations/icts
...
// 询价历史记录汇总界面查询
// GET /v1/{organizationId}/enquiry-detail-audits/query/enquiry-audit-record
...
// 模板导出
// POST https://scm-uat.cmitry.com:8443/ssrc/v1/463/enquiry-price-import/export
...
// 导入结果查询
// GET https://scm-uat.cmitry.com:8443/ssrc/v1/463/enquiry-price-import/validate-failed/{batchId}?page=0&size=10
...
// icts模板导出
// POST /v1/{organizationId}/enquiry-price-icts-import/export
...
// icts导入结果查询
// GET /v1/{organizationId}/enquiry-price-icts-import/validate-failed/{batchId}
...
// CHINA_DIA模板导出
// POST /v1/{organizationId}/enquiry-price-china-dia-import/export
...
// CHINA_DIA导入结果查询
// GET /v1/{organizationId}/enquiry-price-china-dia-import/validate-failed/{batchId}
...
// 费用明细查询
// GET  /v1/{organizationId}/enquiry-detail-dtls/selectByDetailId/{enquiryDetailId}
...
// 询价单行费用明细历史记录列表
// GET  /v1/{organizationId}/enquiry-dtl-audits
...
// 费用明细保存
// POST  /v1/{organizationId}/enquiry-detail-dtls/saveData
...
// 费用明细删除
// PUT /v1/{organizationId}/enquiry-detail-dtls/delete
