...
import DefaultNoPermissionContent from './DefaultNoPermissionContent';
  ...
  extendProps() {
    ...
    if (status === SUCCESS) {
      ...
      return status === PENDING ? (
        <Spin style={{ lineHeight: '100vh', height: '100vh', backgroundColor: '#fff' }} spinning />
      ) : (
        <DefaultNoPermissionContent />
      );
    }
  }
