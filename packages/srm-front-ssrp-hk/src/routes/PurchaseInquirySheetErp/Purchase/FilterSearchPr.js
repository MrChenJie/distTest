...
export default class FilterSearchPr extends React.Component {
  ...
  render() {
    ...
    const { ictPrDetailHeadsList } = purchaseInquirySheetModelErp;
          ...
          <Col {...gridSpan}>
            ...
            >
              {getFieldDecorator('prer', {
                ...
                disabled
                textValue={ictPrDetailHeadsList?.prer}
                code='HKICT.EMPLOYEE'
          ...
          <Col {...gridSpan}>
            ...
            >
              {getFieldDecorator('supDeliveryAddress', {
                ...
                disabled
                textValue={ictPrDetailHeadsList?.supDeliveryAddress} code='CMHK.ERP.ADDRESS'
