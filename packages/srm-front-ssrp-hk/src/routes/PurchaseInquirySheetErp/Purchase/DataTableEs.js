...
export default class DataTableEs extends React.Component {
  ...
  render() {
    ...
    const { ictPrDetailMatList } = purchaseInquirySheetModelErp
    const {
      selectedRows,
      selectedRowKeys,
      rfqResponseVisible,
              ...
              <Form.Item>
                {
                  form.getFieldDecorator(`${record['equipmentAndServiceId']}#serviceType`, {
                    ...
                    (<CusSelect disabled allowClear options={[
              ...
              <Form.Item>
                {
                  form.getFieldDecorator(`${record['equipmentAndServiceId']}#matNo`, {
                    ...
                    (
                      <CusLov disabled textValue={record.matNo}
              ...
              <Form.Item>
                {
                  form.getFieldDecorator(`${record['equipmentAndServiceId']}#quantity`, {
                    ...
                    (<CusInput.TextArea disabled autoChangeSize={true} onChange={() => {
                      setTimeout(() => {
        ...
        render: (val, record) => {
          return (
            <Form className='customize-form'>
              <Form.Item>
                {
                  form.getFieldDecorator('prDateTo', {
