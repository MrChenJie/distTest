 ...
 * @param {String} zipFileName  压缩包名字
 */
export function batchDownloadFileReform(batchFileList = [], ccmFileIdList = [], zipFileName) {
  return new Promise((resolve) => {
    request(`/hfle/v1/${getCurrentOrganizationId()}/files/downloadAndZipAttachmentListCcm`, {
      method: 'POST',
      body: {
        batchFileList,
        ccmFileIdList,
