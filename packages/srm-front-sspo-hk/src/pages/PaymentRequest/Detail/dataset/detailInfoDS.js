...
const detailInfo = ({
  ...
  transport: {
    create: ({ data, params }) => {
      ...
      const { resaleDetailInvoiceList, AttachmentList, otherAttachmentList } = data[0];
      return {
        ...
        data: {
          ...
          costAttachFileList: [...AttachmentList, ...otherAttachmentList],
        },
        params,
      };
    },
