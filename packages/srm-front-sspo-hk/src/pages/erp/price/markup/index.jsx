...
export default class PriceMarkup extends PureComponent {
  ...
  templateImport = () => {
    window.location.href = `${PFM_HOST}/app${SSRC}/price/import`;
  };

  jumpPriceLibraryQuery = () => {
    window.location.href = `${PFM_HOST}/app${SSRC}/price-library/list`;
  };
        ...
        request(`${SSRC}/v1/${tenantInfo.tenantId}/price-entrys/priceEntryAdd`, {
          ...
          .then((resonseData) => {
            ...
            if (resonseData.failed) {
              ...
              window.location.href = `${PFM_HOST}/app${SSRC}/price-entry/detail/${resonseData.priceEntry.priceGroupId}`;
            }
          })
          .catch(() => {
            // console.log('err');
