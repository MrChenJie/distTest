 ...
 */
  ...
  handleAddMat = () => {
    ...
    const { editMatDataSource, infoSource } = contractBidWinningResult;
    const { projectType } = infoSource;
  ...
  render() {
    ...
    const { editMatDataSource = [], enumMap = {}, infoSource } = contractBidWinningResult;
    const { selectedRowKeys = [] } = this.state;
    const { projectNumber, projectType } = infoSource;
    const { budgetType, category } = enumMap;
