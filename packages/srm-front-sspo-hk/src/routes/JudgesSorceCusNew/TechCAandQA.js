...
export default class TechCAandQA extends React.Component {
  ...
  //   const { btnMilestonesEnd } = nextProps;
  //   return {
  //     stateMilestonesEnd: btnMilestonesEnd,
  //   };
  // }
    ...
    milstonesInfo.map((item) => {
      if (milestoneId === item.milestoneId) {
        ...
        if (today > item.milestoneEndTime || item.milestoneState === 'completed') {
          ...
          this.setState({ stateMilestonesEnd: this.props.btnMilestonesEnd });
        }
      }
    })
