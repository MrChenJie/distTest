...
import { Form, Row, Col, Input, Select, Button, DatePicker } from 'hzero-ui';
...
// const commonPrompt = 'spcm.contractApproval.model';
const common = 'spcm.common.model';
@Form.create({ fieldNameProp: null })
@cacheComponent({ cacheKey: '/spcm/contract-approval/list' })
          ...
          <Col span={18}>
            <Row {...SEARCH_FORM_ROW_LAYOUT}>
              <Col span={8}>
                <Form.Item
                  {...formItemLayout}
                  label={intl.get(`${common}.common.purchaseAgreementNum`).d('采购协议编号')}
                >
              ...
              <Col span={8}>
                <Form.Item
                  {...formItemLayout}
                  label={intl.get(`${common}.common.purchaseAgreementName`).d('采购协议名称')}
                >
            ...
            <Row style={{ display: expandForm ? 'block' : 'none' }} {...SEARCH_FORM_ROW_LAYOUT}>
              ...
              <Col span={8}>
                <Form.Item
                  {...formItemLayout}
                  label={intl.get(`${common}.agreementObject`).d('协议对象')}
                >
