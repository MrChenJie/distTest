...
export default class List extends React.Component {
  ...
  getColumns() {
    const columnArray = [
      ...
      {
        title: intl.get(`${common}.common.purchaseAgreementNum`).d('采购协议编号'),
        dataIndex: 'pcNum',
        width: 160,
      ...
      {
        title: intl.get(`${common}.common.purchaseAgreementName`).d('采购协议名称'),
        dataIndex: 'pcName',
      ...
      {
        title: intl.get(`${common}.common.pcKindCode`).d('协议性质'),
      ...
      {
        title: intl.get(`${common}.common.pcTemplateId`).d('协议模板'),
