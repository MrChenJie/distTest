...
@connect(({ loading = {}, contractJudgesSorce = {} }) => ({
    fetchSourceList: loading.effects['contractJudgesSorce/getAnswerList'],
    contractJudgesSorce,
}))
...
export default class ContractMidlle extends Component {
    ...
    render() {
        ...
        const { answerSource = [], milestones = [], answerPagination = {}, enumMap = {} } = contractJudgesSorce;
        const { yesNO = [] } = enumMap;
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <Form.Item>
                            {getFieldDecorator('round', {
                                initialValue: milestones.length > 0 && milestones[0].milestoneId
                            })(
