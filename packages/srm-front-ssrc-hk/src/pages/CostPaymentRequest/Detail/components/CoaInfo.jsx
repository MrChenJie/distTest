...
const CoaInfo = (cosDataSet, lineDataSet, taxDataSet, defaultFlag, financeFlag, batchFlag) => {
  if (!batchFlag) {
    cosDataSet.query();
    taxDataSet.query();
  }
  ...
  return (
    <>
      ...
      {lineDataSet.getField('pendingApportionFlag').getValue() === '1' && !batchFlag && (
        <Form
          dataSet={lineDataSet}
          labelLayout="horizontal"
          columns={2}
