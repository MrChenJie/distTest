...
export default class EvaluateDetail extends React.Component {
  constructor(props) {
    ...
    const { isReturn, isReturnServiceEvaluation } = querystring.parse(search.substr(1));
    this.state = {
      evaluateResultData: {},
      isReturn,
      isReturnServiceEvaluation,
      score: 0, // 分数
  ...
  render() {
    ...
    const { score, detailData, evaluateResultData, isReturn = false, isReturnServiceEvaluation = false } = this.state;
      ...
      <PageHeaderWrapper
        headerProps={{
          backPath: isReturn
            ...
            : isReturnServiceEvaluation
              ? `${isPub ? '/pub' : ''}/spcm/service-evaluation/list`
              : undefined,
        }}
      >
