...
export default ({
  ...
  fields: [
    ...
    },
    {
      ...
      label: intl.get(`spcm.paymentRequest.model.circuitRemainingHkd`).d('客户电路编号收款逾期提醒'),
      bind: 'resaleDetailLine.circuitRemainingHkd',
    },
    {
      name: 'circuitNumber',
    ...
    },
    {
      ...
      label: intl.get(`spcm.paymentRequest.model.circuitRoleType`).d('主理人/代理人'),
      bind: 'resaleDetailLine.circuitRoleType',
    },
    {
      name: 'circuitRoleTypeMeaning',
      label: intl.get(`spcm.paymentRequest.model.circuitRoleType`).d('主理人/代理人'),
      bind: 'resaleDetailLine.circuitRoleTypeMeaning',
    },
    {
      name: 'serviceType',
    ...
    {
      name: 'poLineAmount',
      label: intl.get(`spcm.paymentRequest.model.poLineAmount`).d('订单行NRC金额（原币不含税）'),
    ...
    {
      name: 'paymentArrange',
      label: intl.get(`spcm.paymentRequest.model.paymentArrange`).d('项目付款安排'),
      bind: 'resaleDetailLine.poLines.paymentArrange',
    },
    {
      name: 'paymentArrangeExplain',
      label: intl.get(`spcm.paymentRequest.model.paymentArrangeExplain`).d('项目付款安排说明'),
      bind: 'resaleDetailLine.poLines.paymentArrangeExplain',
    },
    // {
