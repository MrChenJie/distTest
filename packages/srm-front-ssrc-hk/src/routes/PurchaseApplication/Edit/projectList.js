...
export default class ProjectList extends Component {
  ...
  render() {
    ...
    const { prType } = purchaseApplicationModel;

    // 只有框架采购的这几项才能多选
    const isCheckBox = [
      'frameworkProcurement1',
      'frameworkProcurement2',
      'frameworkProcurement3',
      'frameworkProcurement4',
      'frameworkProcurement5',
    ].includes(prType);
    ...
    return (
      <>
        <CusSpin spinning={searchProjectInfoLoading}>
