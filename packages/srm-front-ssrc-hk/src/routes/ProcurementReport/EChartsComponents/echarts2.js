...
export default class echarts2 extends React.Component {
  ...
  componentDidUpdate(props) {
    ...
    const { supplierAmountList } = purchaseApplicationModel;

    option.xAxis.data = supplierAmountList.nameData;
    option.series[0].data = supplierAmountList.valueData;
  ...
  initChart = () => {
    ...
    chart.on('mouseover', 'xAxis', function (e) {
      let axisTip = document.getElementById('tip2');
  ...
  render() {
    return (
      <>
        ...
        <div id="tip2" className={styles['axis-tip']}></div>
      </>
    );
  }
}
