        ...
        <PageWrapper loading={fetchLoading}>
          ...
          >
            <Panel
              ...
              header={
                <PanelHeader
                  title={intl.get(`hzero.common.view.button.search`).d('查询条件')}
            ...
            <Panel
              ...
              header={
                ...
                //     <CusButton mini>{intl.get(`hzero.common.view.button.delete`).d('删除')}</CusButton>
                //     <CusButton mini onClick={(e) => this.addPurchaseType(e)} type='primary'>{intl.get(`hzero.common.view.button.add`).d('新建')}</CusButton>
                //   </>
                // }
                />
              }
        ...
        >
          <Form ref={this.modalForm} className='customize-form'>
            <Form.Item
              ...
              name='prType'
            >
              <CusSelect allowClear options={idpValueMap['HKPC.PRTYPE']} />
            </Form.Item>
            <Form.Item
              required
              label={'是否关联立项'}
