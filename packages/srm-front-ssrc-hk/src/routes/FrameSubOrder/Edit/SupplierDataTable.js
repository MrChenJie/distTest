    ...
    const columns = [
      {
        ...
        required: true,
        render: (val, record) => {
          return infomation.prStatus == 'In_Approval' || infomation.prStatus == '' ? (
            <Form.Item>
                ...
                rules: [
                  {
                    ...
                    message: intl.get('hzero.common.validation.notNull', {
                      name: intl
                        .get(`${promptCode}.view.title.OrderContractOperator`)
                        .d('订单&合同经办人'),
                    }),
                  },
                ],
      ...
      {
        title: intl.get(`${promptCode}.view.title.quotationcurrency`).d('报价币种'),
        width: 100,
