...
export default class PurchaseOrderDataTable extends React.Component {
  ...
  render() {
    ...
    const columns = [
      ...
      // {
      //   title: intl.get(`${promptCode}.view.title.PRAmountH`).d('采购申请金额'),
      //   dataIndex: 'prAmountHkd',
      //   width: 120,
      //   render: (_, record) => {
      //     return (
      ...
      //   },
      // },
      fourthHead?.prApplyBudgetType !== 'INVENTORY' && {
            ...
            <Col {...gridSpan}>
              ...
              >
                {getFieldDecorator('agentName', {
                  initialValue: fourthHead?.agentName,
                })(
                  <CusLov
                    disabled
                    textValue={fourthHead?.agentName}
