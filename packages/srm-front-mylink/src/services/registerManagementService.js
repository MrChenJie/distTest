...
export async function queryList(params) {
  ...
  return request(`${SRM_MYLINK}/v1/${organizationId}/judges/selectJudges`, {
    method: 'GET',
    query,
  });
}
 ...
 */
export async function deleteJudgesLine(params) {
  return request(`${SRM_MYLINK}/v1/${organizationId}/judges`, {
    method: 'DELETE',
    body: params
  });
}
 ...
 * @returns {Promise<void>}
 */
export async function saveHeadInfo(params) {
  return request(`${SRM_MYLINK}/v1/${organizationId}/linkPartJudgeHeads`, {
    method: 'POST',
    body: params
  });
}
...
export async function queryHeadInfo(params) {
  return request(`${SRM_MYLINK}/v1/${organizationId}/linkPartJudgeHeads/${params}`, {
    method: 'GET',
    // body: params
  });
}