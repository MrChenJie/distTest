...
export async function queryList(params) {
  ...
  return request(`${SRM_MYLINK}/v1/${organizationId}/cmhk-mylink/partnerCase/search`, {
    method: 'GET',
    query,
  });
}
...
export async function queryListHistory(params) {
  const query = filterNullValueObject(parseParameters(params));
  return request(`${SRM_MYLINK}/v1/${organizationId}/cmhk-mylink/partnerCaseHistory/search`, {
    method: 'GET',
    query,
  });
}
...
export async function queryDetail(params) {
  return request(`${SRM_MYLINK}/v1/${organizationId}/cmhk-mylink/partnerCase/info/${params.id}`, {
    method: 'GET',
  });
}
