...
export default class UploadButton extends React.Component {
  ...
  @Bind()
  beforeUpload(file) {
    const { fileType, type, fileSize = 100 * 1024 * 1024 } = this.props;
