        ...
        <div className="customize-form">
          <Form ref={this.form}>
            ...
            >
              <Col {...gridSpan}>
                <Form.Item
                  label={intl.get(`spfmhk.mylink.field.cooperate.mode`).d('合作意向')}
                  name='partnerModeId'
                >
                  <CusLov code="LINK.ALL_PART_MODE" lovOptions={{displayField:'cooperationMode',valueField:'modeId'}}></CusLov>
                </Form.Item>
              </Col>
              <Col {...gridSpan}>
                <Form.Item
