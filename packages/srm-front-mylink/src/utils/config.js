...
// #region initConfig
let SRC_WEBSOCKET_HOST = `${process.env.SRC_WEBSOCKET_HOST}`;
let SRM_MDM = '/smdm';
let SRM_PLATFORM = '/spfm';
let SRM_INTERFACE_CONFIG = '/sifc';
let SRM_INTERFACE = '/sitf';
let SRM_SSLM = '/sslm';
let SRM_SPUC = '/spuc-25149';
let SRM_SQAM = '/sqam';
let SRM_SSRC = '/ssrc';
let SRM_CREDIT = '/seci';
let SRM_SCEC = '/scec';
...
let SRM_SPUB = '/spub';
let SRM_TRADE = '/trade'
let SRM_MYLINK = '/mylink'
let SRM_MALL_HOST = `${process.env.SRM_MALL_HOST}`;
let SRM_AMKT_HOST = `${process.env.SRM_AMKT_HOST}`;
// #endregion
...
const helpMethodAssist = {
  ...
  SRM_SPUB: { changeConfig: ['SRM_SPUB'], depBy: [] },
  SRM_TRADE: { changeConfig: ['SRM_TRADE'], depBy: [] },
  SRM_MYLINK: { changeConfig: ['SRM_MYLINK'], depBy: [] },
  SRM_MALL_HOST: { changeConfig: ['SRM_MALL_HOST'], depBy: [] },
  SRM_AMKT_HOST: { changeConfig: ['SRM_AMKT_HOST'], depBy: [] },
};
