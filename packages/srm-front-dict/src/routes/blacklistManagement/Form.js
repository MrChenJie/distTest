        ...
        <div className="customize-form">
          <Form ref={this.form}>
            <GenerateSearchFormGrid onQuery={onSearch} onReset={this.handleReset}>
              ...
              <Col {...gridSpan}>
                <Form.Item
                  label={intl.get(`spfmhk.dict.view.field.companynamecn`).d('公司名称（中文）')}
                  name="cmpanyNameCh"
                >
                  <Input />
                </Form.Item>
              ...
              <Col {...gridSpan}>
                <Form.Item
                  label={intl.get(`spfmhk.dict.view.balcklist.applicant`).d('申请人')}
                  name="creator"
                >
                  <CusLov
                    code="DICT.EMPLOYEE_INFO"
              ...
              <Col {...gridSpan}>
                <Form.Item
                  label={intl.get(`spfmhk.dict.view.field.partner.code`).d('合作伙伴编号')}
                  name="partnerNum"
                >
                  <Input />
                </Form.Item>
              ...
              <Col {...gridSpan}>
                ...
                >
                  <CusSelect
                    style={{ width: '100%' }}
                    allowClear
                    options={idpValueMap['DICT.BLACK_APPLY_STATUS']}
                  />
                </Form.Item>
              </Col>
