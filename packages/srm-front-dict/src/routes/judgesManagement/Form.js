        ...
        <div className="customize-form">
          <Form ref={this.form}>
            <GenerateSearchFormGrid onQuery={onSearch} onReset={this.handleReset}>
              ...
              <Col {...gridSpan}>
                <Form.Item label={intl.get(`spfmhk.dict.view.field.judge.department`).d('评委部门')} name="unitCode">
                  <CusLov
              ...
              <Col {...gridSpan}>
                <Form.Item label={intl.get(`spfmhk.dict.view.field.applicantionstatus`).d('申请状态')} name="applyStatus">
                  <CusSelect
                    style={{ width: '100%' }}
                    allowClear
                    options={idpValueMap['DICT.JUDGE_APPLY_STATUS']}
                  />
                </Form.Item>
              </Col>
