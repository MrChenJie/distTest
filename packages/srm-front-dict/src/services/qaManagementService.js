...
export async function queryList(params) {
  ...
  return request(`${SRM_DICT}/v1/${organizationId}/qas`, {
    method: 'GET',
    query,
  });
}
...
export async function getPartnerInfo(params) {
  return request(`${SRM_DICT}/v1/${organizationId}/qas/partnerInfo`, {
    method: 'GET',
    query: params,
  });
}
...
export async function queryQAList(params) {
  const query = filterNullValueObject(parseParameters(params));
  return request(`${SRM_DICT}/v1/${organizationId}/qas/qaAnswer`, {
    method: 'GET',
    query,
  });
}
...
export async function saveQAList(params) {
  return request(`${SRM_DICT}/v1/${organizationId}/qa-answers/save`, {
    method: 'POST',
    body:params,
  });
}
...
export async function subQAList(params) {
  return request(`${SRM_DICT}/v1/${organizationId}/qa-answers/submit`, {
    method: 'POST',
    body:params,
  });
}
