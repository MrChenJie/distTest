// 从这里开始，页面展示json    begin
// 引入同级目录的bignumber文件
import BigNumber from 'bignumber.js';
let _toString = Object.prototype.toString;
function format_object(object, indent_count) {
  var tmp_array = [];
  ...
  return (
    '<span  data-type="object"><i  style="cursor:pointer;" class="fa fa-minus-square-o" onclick="hide(this)"></i>{<br/>' +
    tmp_array.join(',<br/>') +
    '<br/>' +
  ...
  switch (typeofJson(object)) {
    ...
    case 'Object':
      if (object instanceof BigNumber) {
        ...
        html_fragment = format_object(object, indent_count);
      }
      break;
  }
