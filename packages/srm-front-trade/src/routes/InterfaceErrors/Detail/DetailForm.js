  ...
  render() {
    return (
      <div className="customize-form">
        <Form name="detail" ref={this.detailForm} disabled>
          <Row>
            <Col span={24}>
              <Form.Item
                label={intl
                  .get(`${prompt}.view.detail.interfaceReqHeaderParam`)
                  .d('平台接口调用参数')}
                wrapperCol={{ span: 24 }}
          ...
          <Row>
            <Col span={24}>
              <Form.Item
                label={intl
                  .get(`${prompt}.view.detail.interfaceReqBodyParam`)
                  .d('第三方接口调用参数')}
                wrapperCol={{ span: 24 }}
          ...
          <Row>
            <Col span={24}>
              <Form.Item
                label={intl
                  .get(`${prompt}.view.detail.interfaceRespContent`)
                  .d('第三方接口响应内容')}
                wrapperCol={{ span: 24 }}
