...
module.exports = [
  ...
  },
  {
    ...
    title: intl.get('hzero.common.title.pub.hpfm.code-rule-org.dist').d('编码规则'),
    component: () => import('../routes/CodeRuleOrg/CodeRuleDist'),
    authorized: true,
  ...
  {
    authorized: true,
    path: '/pub/hpfm/value-list',
    title: intl.get('hzero.common.title.pub.hpfm.value-list').d('值集维护'),
    component: () => import('../routes/ValueList'),
    models: [() => import('../models/valueList')],
  },
  {
    authorized: true,
    path: '/pub/hpfm/value-list/detail/:lovId',
    title: intl.get('hzero.common.title.pub.hpfm.value-list').d('值集维护'),
    component: () => import('../routes/ValueList/ValueDetail'),
    models: [() => import('../models/valueList')],
  },
