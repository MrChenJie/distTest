      ...
      <React.Fragment>
        ...
        >
          {form.getFieldDecorator('bankTypeCode', {
            initialValue: data.bankTypeCode || 'CB',
            rules: [
              {
                required: true,
                message: intl.get('hzero.common.validation.notNull', {
        ...
        <Form.Item
          {...MODAL_FORM_ITEM_LAYOUT}
          label={intl.get('hpfm.bank.model.bank.countryCode').d('国家')}
        >
            ...
            rules: [
              {
                required: true,
                message: intl.get('hzero.common.validation.notNull', {
                  name: intl.get('hpfm.bank.model.bank.countryCode').d('国家'),
                }),
              },
            ],
          })(<Lov allowClear code="HPFM.COUNTRY" lovOptions={{ valueField: 'countryCode' }} />)}
        </Form.Item>
        <Form.Item
          {...MODAL_FORM_ITEM_LAYOUT}
