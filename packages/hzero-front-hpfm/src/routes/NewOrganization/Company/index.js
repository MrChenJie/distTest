    ...
    switch (type) {
      ...
      case 'edit':
        this.openModal(
          ...
          intl.get('hsrh.organization.view.message.editCompany').d('编辑公司'),
          type
        );
        break;
      default:
      ...
      <>
        <Row gutter={45}>
          ...
          <Col span={16}>
                ...
                <div style={{ marginBottom: 100 }}>
                  <Col span={8}>
                    <div style={{ color: 'rgb(152, 152, 152)' }}>
                      {intl.get('hpfm.organization.view.company.companyCode').d('公司代码')}
                    </div>
                    <div style={{ overflowWrap: 'break-word' }}>{basicInformation.unitCode}</div>
                  </Col>
                  <Col span={8}>
                    <div style={{ color: 'rgb(152, 152, 152)' }}>
                      {intl.get('hpfm.organization.view.company.companyName').d('公司名称')}
                    </div>
                    <div style={{ overflowWrap: 'break-word' }}>{basicInformation.unitName}</div>
                  </Col>
                  <Col span={8}>
                    <div style={{ color: 'rgb(152, 152, 152)' }}>
                      {intl.get('hpfm.organization.view.company.companyType').d('公司类型')}
                    </div>
                    <div style={{ overflowWrap: 'break-word' }}>
                      {basicInformation.unitTypeMeaning}
                    </div>
                  </Col>
                  <Col span={8}>
                    <div style={{ marginTop: 16, color: 'rgb(152, 152, 152)' }}>
                      {intl.get('hpfm.organization.view.company.connectCompany').d('关联企业')}
                    </div>
                    <div style={{ overflowWrap: 'break-word' }}>
                      {basicInformation.companyName
                        ? basicInformation.companyName
                        : intl.get('hpfm.organization.view.company.nothing').d('无')}
                    </div>
                  </Col>
                  <Col span={8}>
                    <div style={{ marginTop: 16, color: 'rgb(152, 152, 152)' }}>
                      {intl.get('hpfm.organization.view.company.supervisorFlag').d('主管部门')}
                    </div>
                  ...
                  <Col span={8}>
                    <div style={{ marginTop: 16, color: 'rgb(152, 152, 152)' }}>
                      {intl.get('hpfm.organization.view.company.currentStatus').d('状态')}
                    </div>
                    <div style={{ overflowWrap: 'break-word', marginLeft: '2px' }}>
                      <Badge
            ...
            >
              <TabPane
                tab={intl.get('hpfm.organization.view.title.employeeInformationTab').d('员工信息')}
              ...
              <TabPane
                tab={intl.get('hpfm.organization.view.title.positionInformationTab').d('岗位信息')}
