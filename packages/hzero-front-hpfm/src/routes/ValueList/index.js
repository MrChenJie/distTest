...
import { Avatar, Col, Row, Tag } from 'hzero-ui';
...
import addBtn from '../../assets/buttonIcons/新建.png';
import delBtn from '../../assets/buttonIcons/删除.png';
...
export default class ValueList extends React.Component {
    ...
    return (
      <Row style={{ marginTop: '15px', marginBottom: '15px' }}>
        ...
        <Col span={12} className="customize-buttons">
          ...
          >
            <img src={addBtn} alt="" style={{ width: '15px' }} />
          ...
          {!isEmpty(selectedRows) && (
            ...
            >
              <img src={delBtn} alt="" style={{ width: '15px' }} />
  ...
  tableProps() {
    const { history, loading, tenantId, isSiteFlag, match, location } = this.props;
          ...
          const operators = [
            {
              ...
              ele: (
                <ButtonPermission
                  ...
                  style={{ width: '30px' }}
                  onClick={() => {
                    history.push(`${isPub ? '/pub' : ''}/hpfm/value-list/detail/${record.lovId}`);
                  }}
                >
