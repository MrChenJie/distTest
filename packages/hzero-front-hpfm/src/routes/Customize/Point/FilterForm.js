  ...
  return (
    <Form>
      <Row type="flex" gutter={24} align="bottom">
        ...
        <Col span={6}>
          <Form.Item label={intl.get('hpfm.customize.model.customize.point.packageName').d('包名')}>
            {getFieldDecorator('packageName')(<Input />)}
          </Form.Item>
        </Col>
        <Col span={6}>
          <Form.Item label={intl.get('hpfm.customize.model.customize.point.className').d('类名')}>
