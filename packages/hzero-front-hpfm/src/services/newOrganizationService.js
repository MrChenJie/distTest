 ...
 */
export async function updateDepartmentInformation(params) {
 ...
 * @param {Object} params - 参数
 */
export async function addEmployeeDetail(params) {
 ...
 * @param {Object} params - 参数
 */
export async function updateEmployeeDetail(params) {
  return request(`${HZERO_PLATFORM}/v1/${organizationId}/plus/employees`, {
    method: 'PUT',
    body: params,
  });
