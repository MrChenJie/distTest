...
const tableDs = {
  ...
  queryFields: [
    !isTenantRoleLevel() && {
      name: 'tenantLov',
      type: 'object',
      label: intl.get('hmsg.callServer.model.callServer.tenantName').d('租户名称'),
      lovCode: 'HPFM.TENANT',
      noCache: true,
      ignore: 'always',
    },
    ...
    },
    {
      name: 'enabledFlag',
      type: 'string',
      label: intl.get('hmsg.callServer.model.callServer.enabledFlag').d('状态'),
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'string',
      label: intl.get('hmsg.callServer.model.callServer.serverTypeCodeMeaning').d('服务类型'),
    },
    isTenantRoleLevel() &&
      !VERSION_IS_OP && {
        name: 'tenantId',
        type: 'string',
        label: intl.get('hmsg.callServer.model.callServer.source').d('来源'),
      },
    {
      name: 'enabledFlag',
      type: 'boolean',
      label: intl.get('hmsg.callServer.model.callServer.enabledFlag').d('启用标识'),
      trueValue: 1,
      falseValue: 0,
      defaultValue: 1,
    },
