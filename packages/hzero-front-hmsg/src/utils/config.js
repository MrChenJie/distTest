...
let HISTORY_ENABLE = `${process.env.HISTORY_ENABLE}`;
let SVG_ICON_ENABLE = `${process.env.SVG_ICON_ENABLE}`;
...
let MARKET_CLIENT_SDK_FLAG = `${process.env.MARKET_CLIENT_SDK_FLAG}`;
...
let BKT_HTDO = `${process.env.BKT_HTDO || 'htdo'}`;
  ...
  if (key && value) {
    switch (key) {
      ...
      case 'HISTORY_ENABLE':
        ...
        break;
      case 'SVG_ICON_ENABLE':
        SVG_ICON_ENABLE = value;
        break;
      ...
      case 'BAIDU_MAP_AK':
        BAIDU_MAP_AK = value;
        break;
      case 'MARKET_CLIENT_SDK_FLAG':
        MARKET_CLIENT_SDK_FLAG = value;
        break;
      case 'HZERO_PLATFORM':
...
const helpMethodAssist = {
  ...
  HISTORY_ENABLE: { changeConfig: ['HISTORY_ENABLE'], depBy: [] },
  SVG_ICON_ENABLE: { changeConfig: ['SVG_ICON_ENABLE'], depBy: [] },
  ...
  MARKET_CLIENT_SDK_FLAG: { changeConfig: ['MARKET_CLIENT_SDK_FLAG'], depBy: [] },
  ...
  HZERO_HTDO: { changeConfig: ['HZERO_HTDO'], depBy: [] },
  HZERO_HKMS: { changeConfig: ['HZERO_HKMS'], depBy: [] },

  HZERO_HPRT: { changeConfig: ['HZERO_HPRT'], depBy: [] },
  HZERO_HWKF: { changeConfig: ['HZERO_HWKF'], depBy: [] },
  HZERO_HBAI: { changeConfig: ['HZERO_HBAI'], depBy: [] },
  ...
  BKT_HTDO: { changeConfig: ['BKT_HTDO'], depBy: [] },
