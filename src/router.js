...
import { SRM_MALL_HOST, SRM_PLATFORM, SRM_SCEC } from '_utils/config';
          ...
          <ConnectedRouter history={history}>
            <React.Fragment>
              ...
              <Switch>
                ...
                <Route path='/hande/external/sc/public' render={(props) => <PublicLayout {...props} />} />
                <Route path='/hande/external/en/public' render={(props) => <PublicLayout {...props} />} />
                <Route path='/hande/external/tc/public' render={(props) => <PublicLayout {...props} />} />
                <Route path='/external/sc/public' render={(props) => <PublicLayout {...props} />} />
                <Route path='/external/en/public' render={(props) => <PublicLayout {...props} />} />
                <Route path='/external/tc/public' render={(props) => <PublicLayout {...props} />} />
